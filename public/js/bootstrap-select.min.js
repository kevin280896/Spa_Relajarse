        ...
        k.VERSION = "1.12.2", k.DEFAULTS = {
            ...
            createLi: function () {
                var c = this,
                    ...
                    j = function (d, e, f, g) {
                        return '<a tabindex="0" class="' + (e = "dropdown-item " + (e || "")) + '"' + (f ? ' style="' + f + '"' : "") + (c.options.liveSearchNormalize ? ' data-normalized-text="' + b(i(a(d).html())) + '"' : "") + (void 0 !== g || null !== g ? ' data-tokens="' + g + '"' : "") + ' role="option">' + d + '<span class="' + c.options.iconBase + " " + c.options.tickIcon + ' check-mark"></span></a>'
                    };
                    ...
                    if (g++, !f.hasClass("bs-title-option")) {
                        ...
                        if (f.data("content") || (o = r + '<span class="text">' + o + q + "</span>"), t && !0 !== f.data("divider")) {
                            ...
                            if (0 === f.index()) {
                                ...
                                y = (s.data("icon") ? '<span class="' + c.options.iconBase + " " + s.data("icon") + '"></span> ' : "") + '<span class="text">' + i(y) + z + "</span>", 0 !== b && d.length > 0 && (g++, d.push(h("", null, "divider", e + "div"))), g++, d.push(h(y, null, "dropdown-header" + x, e))
                            }
